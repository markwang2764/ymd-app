...
export function _fetchAgentType (data) {
  return fetch('V4/getAgentUserInfo', 'post', data)
}

export function _fetchMdCart (data) {
  return fetch('V4/getCartServeType', 'post', data)
}
